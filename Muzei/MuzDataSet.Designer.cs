...
namespace Muzei {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("MuzDataSet")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class MuzDataSet : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        protected MuzDataSet(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            MuzDataSet cln = ((MuzDataSet)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "MuzDataSet";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/MuzDataSet.xsd";
        ...
        public partial class ПерсоналDataTable : global::System.Data.TypedTableBase<ПерсоналRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ПерсоналRow AddПерсоналRow(string ФИО, string Должность, string Номер_телефона) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ПерсоналRow FindBy__(int __) {
        ...
        public partial class ПерсоналRow : global::System.Data.DataRow {
            ...
            public int __ {
                get {
                    return ((int)(this[this.tableПерсонал.@__Column]));
                }
                set {
                    this[this.tableПерсонал.@__Column] = value;
                }
            }
            ...
            public string Номер_телефона {
                get {
                    try {
                        return ((string)(this[this.tableПерсонал.Номер_телефонаColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Номер телефона\' в таблице \'Персонал\' равно DBNull.", e);
                    }
                }
                set {
...
namespace Muzei.MuzDataSetTableAdapters {
    ...
    public partial class ПерсоналTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Персонал` WHERE ((`№` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` " +
                "= ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)) AND ((? = 1 AND" +
                " `Номер телефона` IS NULL) OR (`Номер телефона` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Персонал` (`ФИО`, `Должность`, `Номер телефона`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Персонал` SET `ФИО` = ?, `Должность` = ?, `Номер телефона` = ? WHERE ((`№` = ?) AND ((? = 1 AND `ФИО` IS NULL) OR (`ФИО` = ?)) AND ((? = 1 AND `Должность` IS NULL) OR (`Должность` = ?)) AND ((? = 1 AND `Номер телефона` IS NULL) OR (`Номер телефона` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [№], ФИО, Должность, [Номер телефона] FROM Персонал";
        ...
        public virtual int Fill(MuzDataSet.ПерсоналDataTable dataTable) {
        ...
        public virtual MuzDataSet.ПерсоналDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MuzDataSet.ПерсоналDataTable dataTable = new MuzDataSet.ПерсоналDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MuzDataSet.ПерсоналDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MuzDataSet dataSet) {
        ...
        public virtual int Delete(int _Original__, string Original_ФИО, string Original_Должность, string Original_Номер_телефона) {
        ...
        public virtual int Insert(string ФИО, string Должность, string Номер_телефона) {
            if ((ФИО == null)) {
        ...
        public virtual int Update(string ФИО, string Должность, string Номер_телефона, int _Original__, string Original_ФИО, string Original_Должность, string Original_Номер_телефона) {
            if ((ФИО == null)) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateUpdatedRows(MuzDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._персоналTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateInsertedRows(MuzDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._персоналTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        private int UpdateDeletedRows(MuzDataSet dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._персоналTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        public virtual int UpdateAll(MuzDataSet dataSet) {
            if ((dataSet == null)) {
